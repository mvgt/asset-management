...
<body class="metro">
	...
	<div class="span6 offset2">
		<%
			...
			ResultSet rs = stmt.executeQuery("select UNAME,USERNAME ,CONTACT, EMAIL, GENDER,ADDRESS from usertable where username='"+uname+"'");
		...
		<form action="UserProfile" method="post">
			...
			<fieldset>
				...
				<div class="input-control text" data-role="input-control">
					<input type="text" name="fullName" value=<%=rs.getString(1)%>>
